...
const About:FC = () => {
    ...
    return (
        <section className='w-screen bg-gradient-to-b from-transparent to-slate-900'>

            <div className="w-full h-min min-h-screen relative flex flex-col justify-center py-20 px-4 main-content" ref={containerRef} id="about">
                <AnimatePresence>
                {isInView && (
                    <>
